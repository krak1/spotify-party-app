...
export default class Room extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            song: {image_url: "https://static01.nyt.com/images/2020/03/19/smarter-living/00well-handwashing-psa-music-notes/00well-handwashing-psa-music-notes-jumbo-v3.gif?quality=90&auto=webp",
    ...
    componentDidMount() {
        this.interval = setInterval(this.getCurrentSong, 1100)
    }
    ...
    authenticateSpotify() {
        ...
        .then((data)=> {
            console.log("In the authenticateSpotify func in Room.js",data);
    ...
    getCurrentSong() {
        fetch('/spotify/current-song').then((response)=> {
            if (!response.ok)
                return {"error": "getCurrentSong Room.js error here"}
            else
                return response.json();
        }).then((data)=>{
